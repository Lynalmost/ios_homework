...
class ViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let t1 = Teacher(firstName: "Li", lastName: "guiyang", age: 35, gender: Gender.male, title: "professor")
        let t2 = Teacher(firstName: "Chen", lastName: "rui", age: 42, gender: Gender.female, title: "lecturer")
        let s1 = Student(firstName: "Li", lastName: "Yin", age: 20, gender: Gender.male, stuNo: "2016110318")
        let s2 = Student(firstName: "Xie", lastName: "Xin", age: 21, gender: Gender.male, stuNo: "2015110146")
        let s3 = Student(firstName: "Li", lastName: "Xin", age: 20, gender: Gender.female, stuNo: "2016110317")
